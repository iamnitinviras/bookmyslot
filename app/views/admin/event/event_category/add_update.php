                            ...
                            <div class="page-title-box pb-0 d-sm-flex">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin/dashboard'); ?>"><?php echo translate('event_category'); ?></a></li>
                                        <li class="breadcrumb-item active"><?php echo isset($id) && $id > 0 ? translate('update') : translate('add'); ?> <?php echo translate('event_category'); ?></li>
                                    </ol>
                                </div>
                            </div>
                        </div>
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <section class="form-light px-2 sm-margin-b-20 ">
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h5 class="black-text font-bold mb-0"></h5>
                    </div>
