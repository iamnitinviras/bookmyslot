            ...
            <section class="form-light px-2 sm-margin-b-20 ">
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h5 class="black-text font-bold mb-0"><?php echo isset($add_on_id) && $add_on_id > 0 ? translate('update') : translate('add'); ?> <?php echo translate("service") . " " . translate('add_ons'); ?></h5>
                    </div>
