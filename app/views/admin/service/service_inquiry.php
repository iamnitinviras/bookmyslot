                                        ...
                                        foreach ($app_contact_us as $mem_key => $mem_row) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="javascript:void(0)" data-bs-toggle="modal" data-id="<?php echo $mem_row['id']; ?>" data-email="<?php echo $mem_row['email']; ?>" data-name="<?php echo $mem_row['name']; ?>" data-subject="<?php echo $mem_row['subject']; ?>" onclick='send_reply(this)' data-bs-target="#appointment-record" data-id="<?php echo (int) $row['id']; ?>" class="btn-floating btn-sm blue-gradient" title="<?php echo translate('send') . " " . translate('reply'); ?>"><i class="fa fa-reply"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
