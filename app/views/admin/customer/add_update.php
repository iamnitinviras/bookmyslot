    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                echo form_open_multipart($folder_name . '/customer/save', $attributes);
                ?>
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a href="<?php echo base_url('admin/customer'); ?>" class="btn btn-outline-secondary"><?php echo translate('cancel'); ?></a>
                    </div>
                </div>
                <?php echo form_close(); ?>
