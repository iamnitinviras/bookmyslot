                        ...
                        <div class="card mt-4">
                            <div class="card-header">
                                ...
                                <span class="col-md-9 col-9 m-0">
                                    <h5 class="black-text font-bold mb-0"><?php echo translate('manage'); ?> <?php echo translate('currency'); ?></h5>
                                </span>
                                    <span class="col-md-3 col-3 text-right m-0">
                                    <a href='<?php echo base_url($folder_name . '/add-currency'); ?>' class="btn btn-outline-success"><i class="fa fa-plus-circle"></i></a>
                                </span>
                                </div>
                            </div>
                            <div class="card-body">
