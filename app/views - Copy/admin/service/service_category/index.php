                                ...
                                <div class="row">
                                    <span class="col-md-9 col-9 m-0">
                                        ...
                                        <?php if ($this->session->userdata('Type_' . ucfirst($this->uri->segment(1))) == 'V') { ?>
                                            <a  href='<?php echo base_url('vendor/add-service-category'); ?>' class="btn btn-outline-success"><i class="fa fa-plus-circle"></i></a>
                                        <?php } else { ?>
                                            <a  href='<?php echo base_url('admin/add-service-category'); ?>' class="btn btn-outline-success"><i class="fa fa-plus-circle"></i></a>
                                        <?php } ?>
                                    </span>
                                </div>
                            </div>
