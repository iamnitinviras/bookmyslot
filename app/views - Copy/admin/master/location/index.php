                        ...
                        <div class="card mt-4">
                            <div class="card-header">
                                ...
                                <span class="col-md-9 col-9 m-0">
                                    <h5 class="black-text font-bold mb-0"><?php echo translate('manage'); ?> <?php echo translate('location'); ?></h5>
                                </span>
                                    <span class="col-md-3 col-3 text-right m-0">
                                    <?php if ($this->session->userdata('Type_' . ucfirst($this->uri->segment(1))) == 'V') { ?>
                                        <a  href='<?php echo base_url('vendor/add-location'); ?>' class="btn btn-outline-success"><i class="fa fa-plus-circle"></i></a>
                                    <?php } else { ?>
                                        <a  href='<?php echo base_url('admin/add-location'); ?>' class="btn btn-outline-success"><i class="fa fa-plus-circle"></i></a>
                                    <?php } ?>
                                </span>
                                </div>
                            </div>
