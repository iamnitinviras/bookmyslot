...
class Service extends MY_Controller {
    ...
    public function index() {
        ...
        $event = $this->model_event->getData('', 'app_event.*,app_event_category.title as category_title,app_admin.company_name, app_admin.first_name, app_admin.last_name,app_city.city_title,app_location.loc_title', $service_condition, $join);
